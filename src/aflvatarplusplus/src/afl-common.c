...
char **get_qemu_argv(int user_qemu_mode, u8 *own_loc, u8 **target_path_p, int argc, char **argv) {
  ...
  *target_path_p = new_argv[0] = find_afl_binary(own_loc, "afl-qemu-trace");
      ...
      *target_path_p = new_argv[0] = find_afl_binary(own_loc, "afl-qemu-system-trace");
  }
  return new_argv;
