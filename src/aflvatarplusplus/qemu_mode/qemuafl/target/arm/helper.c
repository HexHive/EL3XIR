...
static void arm_cpu_do_interrupt_aarch32_hyp(CPUState *cs)
{
    ...
    case EXCP_PREFETCH_ABORT:
        // in case we hit a data abort or a prefetch abort 
        //we consider this a crash for afl -> indicate with abort
        qemu_log("AFL DATA/PREFETCH ABORT AARCH32 HYP DETECTED! \n");
        abort();
...
static void arm_cpu_do_interrupt_aarch64(CPUState *cs)
{
    ...
    case EXCP_DATA_ABORT:
        // in case we hit a data abort or a prefetch abort 
        //we consider this a crash for afl -> indicate with abort
        // for sec monitor and aarch64 targets this is the place to be
        qemu_log("AFL DATA/PREFETCH ABORT AARCH32 HYP DETECTED! \n");
        abort();
