...
static void disas_a64_insn(CPUARMState *env, DisasContext *s)
{
    ...
    //qemu_log("AFLTEST start after snippet disas_a64_insn pc: %lx pid %d\n", s->base.pc_next, getpid());

    s->pc_curr = s->base.pc_next;
    insn = arm_ldl_code(env, s->base.pc_next, s->sctlr_b);
    //qemu_log("AFLTEST after arm_ldl_code pid %d\n", getpid());
    s->insn = insn;
    s->base.pc_next += 4;
    ...
    //qemu_log("AFLTEST check 1 disas_a64_insn pc: %lx pid %d\n", s->base.pc_next, getpid());
    if (dc_isar_feature(aa64_bti, s)) {
    ...
    //qemu_log("AFLTEST check 2 disas_a64_insn pc: %lx pid %d\n", s->base.pc_next, getpid());
    ...
    //qemu_log("AFLTEST return disas_a64_insn pc: %lx pid %d\n", s->pc_curr, getpid());
}
...
static void aarch64_tr_translate_insn(DisasContextBase *dcbase, CPUState *cpu)
{
    ...
    //qemu_log("returning from aarch64_tr_translate pid %d\n", getpid());
}
