...
void HELPER(afl_maybe_log)(target_ulong cur_loc) {
  ...
  //printf("instrumenting:"TARGET_FMT_lx"\n",cur_loc);
...
static void afl_gen_trace(target_ulong cur_loc) {
  ...
  //printf("AFLTEST in afl_gen_trace: cur_block_is_good:%d\n",cur_block_is_good);
...
//   printf("before mangling:"TARGET_FMT_lx"\n",cur_loc);
  cur_loc = (cur_loc >> 4) ^ (cur_loc << 8);
  cur_loc &= MAP_SIZE - 1;
//   printf("after mangling:"TARGET_FMT_lx"\n",cur_loc);
