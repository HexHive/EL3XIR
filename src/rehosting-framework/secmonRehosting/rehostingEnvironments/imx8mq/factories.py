...
from .imx8mq_boot_patcher import Imx8mqBootPatcher
from .imx8mq_call_into_secmon_strategy import Imx8mqCallIntoSecMonStrategyBase
...
class SecMonImx8mqAvatarFactory:
    ...
    def __init__(self):
        ...
        # BL31_BASE taken from platform_def.h in /plat/imx/imx8m/imx8mq/include
        self._secmon_addr = 0x910000
        ...
        self._tzos_entry_addr = 0xfe000000

        # this is the entrypoint of the rich OS booting "last eret of SM boot"
        # this address can be defined in the bl_params (here an arbitrary address is choosen)
        self._normal_entry_addr = 0x40200000

        # map secure monitor binary here
        # BL31_BASE and BL31_LIMIT
        self.secmon_binary = AvatarFactoryMemoryMapping(0x910000, 0x10000)
    ...
    def get_rehosting_context(self, secmon_binary_path: str, avatar_output_dir: str = None):
        ...
        # minimal bootloader from 0x1000 until 0x2000
        avatar.add_memory_range(0x2000, 0x90E000, name="after_minimal_bootloader")
        # secmon binary from 0x910000 until 0x920000
        ...
        avatar.add_in_memory_buffer_peripheral(0x920000, 0x2FF40000, name="after_secmon_binary")
        avatar.add_pl011(0x30860000, 0x1000, "uart0", 0)
        avatar.add_in_memory_buffer_peripheral(0x30861000, 0xF99F000, name="after_uart")
        avatar.add_in_memory_buffer_peripheral(0x40201000, 0xBDDFF000, name="after_normal_stub")      
        avatar.add_memory_range(0xfe001000, 0x1FFF000, name="after_secure_stub")
