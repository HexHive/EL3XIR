...
from secmonRehosting.rehostingEnvironments.xilinxZynqmp.factories import SecMonZynqmpAvatarFactory
...
def main(secmon_binary_path, avatar_output_dir):
    ...
    if avatar_output_dir:
        ...
        factory = SecMonZynqmpAvatarFactory()
        ...
        runner.cont()
        print("Zynqmp SecMonitor booted!")
